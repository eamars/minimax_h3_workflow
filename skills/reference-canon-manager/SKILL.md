...
- Keep camera position, viewpoint, lens, and shot coverage storyboard-owned; a camera move may reveal a different approved part of the same environment but may not create architecture outside the projection.
