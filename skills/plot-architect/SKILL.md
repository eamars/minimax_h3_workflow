...
Consume schema-valid, immutable `project-request` and `canon-lock` revisions plus an optional prior plot revision and scoped revision request. Require exact hashes and project IDs. Block on unresolved premise or canon conflicts instead of inventing.
...
1. Verify source schemas, revisions, hashes, project identity, and conflicts.
...
- Preserve exact input hashes and immutable prior artifacts.
