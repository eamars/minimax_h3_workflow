...
Consume revision-pinned project request, plot, scene-performance, canon/asset manifest when audio references exist, and optional scoped revision request. Reject stale hashes and infer nothing from filenames.
...
1. Validate source envelopes, hashes, IDs, triggers, and audio reference roles.
...
- Validate sound schema, artifact envelope, exact sources, canonical hash, and immutable revision.
...
- Refuse approved overwrites and downstream-authority leakage.
