...
1. Validate envelopes, source revisions, IDs, status, and FPS/timebase.
...
- Preserve stable IDs, source revisions, reference roles, and upstream decisions.
- Perform no generation, workflow compilation, media processing, or validation.
...
- Validate animatic schema, metadata, IDs, revisions, and exact sources.
